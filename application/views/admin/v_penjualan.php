        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <h1 class="page-header">Transaksi
                    ...
                    <a href="#" data-toggle="modal" data-target="#largeModal" class="pull-right"><small style="font-weight:bold;">Cari Produk!</small></a>
                </h1>
                ...
                <table class="table table-bordered table-condensed" style="font-size:20px;margin-top:10px;font-color:black;">
                    <thead>
                        <tr>
                            <th>Kode Barang</th>
                            <th>Nama Barang</th>
                            <th style="text-align:center;font">Satuan</th>
                            <th style="text-align:center;font">Harga(Rp)</th>
                            <th style="text-align:center;font">Diskon(Rp)</th>
                            <th style="text-align:center;font">Qty</th>
                            <th style="text-align:center;font">Sub Total</th>
                            <th style="width:100px;text-align:center;font">Aksi</th>
                        </tr>
                    </thead>
                    <tbody>
                        <?php $i = 1; ?>
