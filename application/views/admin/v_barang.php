                    ...
                    <form class="form-horizontal" method="post" action="<?php echo base_url() . 'admin/barang/tambah_barang' ?>">
                        ...
                        <div class="col-xs-9">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-9">
                                    <input name="kode_barcode" class="form-control" type="text" placeholder="Kode Barcode..." style="width:335px;" required>
                                </div>
                            </div>
                        ...
                        <form class="form-horizontal" method="post" action="<?php echo base_url() . 'admin/barang/edit_barang' ?>">
                            <div class="modal-body">
                                ...
                                <div class="form-group">
                                    <label class="control-label col-xs-3">Kode Barcode</label>
                                    <div class="col-xs-9">
                                        <input name="kode_barcode" class="form-control" type="text" value="<?php echo $kode_barcode; ?>" placeholder="Kode Barcode..." style="width:335px;" required>
                                    </div>
                                </div>
